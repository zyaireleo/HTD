...
def build_swin_backbone(args):
    ...
    visual_backbone = Backbone(args.visual_backbone, args.use_checkpoint, args.backbone_pretrained)
    visual_backbone = Joiner(visual_backbone, position_embedding)
    position_embedding = build_position_encoding(args)
    depth_backbone = Backbone(args.visual_backbone, args.use_checkpoint, args.backbone_pretrained)
