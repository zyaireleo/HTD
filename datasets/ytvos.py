...
class YTVOSDataset(Dataset):
    ...
    def prepare_metas(self):
        ...
        with open("/Users/zyaire/Desktop/codes/G-RVOS/meta.json", 'r') as f:
    ...
    def __getitem__(self, idx):
        ...
        while not instance_check:
            ...
            imgs, ds, labels, boxes, masks, valid = [], [], [], [], [], []
            for j in range(self.num_frames):
                frame_indx = sample_indx[j]
                frame_name = frames[frame_indx]
                img_path = os.path.join(str(self.img_folder), 'JPEGImages', video, frame_name + '.jpg')
                depth_path = os.path.join(str(self.img_folder), 'JPEGDepth', video, frame_name + '.png')
            ...
            imgs, ds, target = self._transforms(imgs, ds, target)
...
def build(image_set, args):
    ...
    PATHS = {
        "train": (root / "valid", "/Users/zyaire/Desktop/codes/G-RVOS/meta_exp.json"),
