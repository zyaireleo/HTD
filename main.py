...
if __name__ == '__main__':
    ...
    if args.pretrained_weights is None:
        args.lr *= bs * gpu_num / 2
        args.lr_visual_backbone *= bs * gpu_num / 2
        args.lr_depth_backbone *= bs * gpu_num / 2
        args.lr_text_encoder *= bs * gpu_num / 2
    else:
        args.lr *= bs * gpu_num / 4
        args.lr_visual_backbone *= bs * gpu_num / 4
        args.lr_depth_backbone *= bs * gpu_num / 4
    print(
        "\n **** After adjust with GPU&BATCH num {}/{}, lr: {}, lr_visual_backbone: {},lr_depth_backbone: {}, lr_text_backbone: {}. **** \n"
        .format(gpu_num, args.batch_size, args.lr, args.lr_visual_backbone, args.lr_depth_backbone,
                args.lr_text_encoder))
    main(args)
