...
def get_args_parser():
    ...
    parser.add_argument('--lr_visual_backbone', default=5e-5, type=float)
    parser.add_argument('--visual_backbone_pretrained', default='/Users/zyaire/Downloads/swin_tiny_patch244_window877_kinetics400_1k.pth', type=str)
    parser.add_argument('--depth_backbone_pretrained', default='/Users/zyaire/Downloads/swin_tiny_patch244_window877_kinetics400_1k.pth', type=str)
    parser.add_argument('--lr_depth_backbone', default=5e-5, type=float)
    parser.add_argument('--lr_visual_backbone_names', default=['visual_backbone.0'], type=str, nargs='+')
    parser.add_argument('--lr_depth_backbone_names', default=['depth_backbone.0'], type=str, nargs='+')
    ...
    parser.add_argument('--visual_backbone', default='video_swin_t_p4w7', type=str,
                        help="Name of the convolutional backbone to use")
    parser.add_argument('--depth_backbone', default='video_swin_t_p4w7', type=str,
                        help="Name of the convolutional backbone to use")
    ...
    parser.add_argument('--dataset_file', default='a2d', help='Dataset name')
    parser.add_argument('--coco_path', type=str, default='/Volumes/datasets/coco')
    parser.add_argument('--ytvos_path', type=str, default='/Users/zyaire/Downloads/ref-youtube-vos')
    parser.add_argument('--davis_path', type=str, default='/Volumes/datasets/ref-davis')
    parser.add_argument('--a2d_path', type=str, default='/Volumes/datasets/a2d_sentences')
    parser.add_argument('--jhmdb_path', type=str, default='/Volumes/datasets/jhmdb_sentences')
    ...
    # parser.add_argument('--resume', default='/Users/zyaire/Downloads/checkpoint.pth', help='resume from checkpoint')
